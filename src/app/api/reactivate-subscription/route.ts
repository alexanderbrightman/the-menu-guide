// Legacy: the app UI now reactivates via Stripe Customer Portal. Webhooks
// still clear cancel_at_period_end. This route is unused by the UI during
// the portal transition and can be removed once that path is confirmed in live.
