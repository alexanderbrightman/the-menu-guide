                    ...
                    <div className="hidden md:block relative">
                        <div className="flex items-center gap-3">
                            <Button
                                ...
                                variant="ghost"
                                className={`text-slate-900 hover:bg-gray-100 rounded-lg transition-all ${expandedSection === 'contact' ? 'bg-white/80 shadow-md' : ''}`}
                            >
                                Contact
                            </Button>
                            ...
                            <Button
                                ...
                                variant="outline"
                                className={`border-black text-slate-900 hover:bg-gray-100 rounded-lg transition-all ${expandedSection === 'login' ? 'bg-white/80 shadow-md' : ''}`}
                            >
                                Sign In
                            </Button>
                        </div>
                        ...
                        <div
                            className={`absolute right-0 top-full mt-2 w-[400px] transition-all duration-300 ease-out origin-top ${expandedSection === 'contact'
                        ...
                        <div
                            className={`absolute right-0 top-full mt-2 w-[400px] transition-all duration-300 ease-out origin-top ${expandedSection === 'login'
                                ? 'opacity-100 scale-y-100 translate-y-0'
                                : 'opacity-0 scale-y-0 -translate-y-2 pointer-events-none'
                                }`}
                        >
                ...
                <div className="h-full flex flex-col">
                    ...
                    <div className="flex justify-between items-center px-4 pt-6 pb-4">
                        <Link
                            ...
                            className="text-2xl font-light text-slate-900 font-mono"
                        >
                            The Menu Guide
                        </Link>
                        <button
                            onClick={closeMobileMenu}
                            className="p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100/50 rounded-full transition-colors"
                    ...
                    <div className="flex-1 overflow-y-auto px-4 py-6">
                        <nav className="flex flex-col gap-2">
                            ...
                            <a
                                ...
                                className="w-full py-4 px-5 text-left text-lg font-medium rounded-xl transition-all duration-300 text-slate-700 hover:bg-white/50"
                            >
                                Home
                            </a>
                            ...
                            <div className="overflow-hidden">
                                ...
                                >
                                    <div className="p-5 mt-2 bg-white/60 rounded-xl">
                                        <AuthForm
                            ...
                            <div className="overflow-hidden">
                                ...
                                >
                                    <form onSubmit={handleContactSubmit} className="p-5 mt-2 bg-white/60 rounded-xl space-y-4">
                                        <div>
